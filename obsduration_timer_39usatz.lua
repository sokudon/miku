...
--	return offsets[i];
function get_pst(t)
stlen=tonumber(#PSTabbrs)
for i=1,stlen do
if(tonumber(t) < tonumber(PSTuntils[i]))then
...
function script_defaults(settings)
	...
	obs.obs_data_set_default_string(settings, "start_text", "2024-01-31 15:00PST")
	obs.obs_data_set_default_string(settings, "stop_text", "2024-02-08 21:00PST")
	...
	obs.obs_data_set_default_string(settings, "title_text", "キャンドルの香りは思い出と共に")
