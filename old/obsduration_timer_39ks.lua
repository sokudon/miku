...
function script_defaults(settings)
	...
	obs.obs_data_set_default_string(settings, "start_text", "2024-01-31 15:00KST")
	obs.obs_data_set_default_string(settings, "stop_text", "2024-02-08 21:00KST")
	...
	obs.obs_data_set_default_string(settings, "para_text", "KST現在時間%UTC\nKST終了時間%EU\n経過時間KST\n残り時間%L\nイベント時間%I\n%T%P％\n%Q")
