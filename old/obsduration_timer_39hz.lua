...
function script_defaults(settings)
	...
	obs.obs_data_set_default_string(settings, "start_text", "2024-01-31 15:00HKT")
	obs.obs_data_set_default_string(settings, "stop_text", "2024-02-08 21:00HKT")
	...
	obs.obs_data_set_default_string(settings, "para_text", "HKT現在時間%UTC\nHKT終了時間%EU\n経過時間HKT\n残り時間%L\nイベント時間%I\n%T%P％\n%Q")
